...
import com.example.grimmy.databinding.DialogStartTimePickerBinding

class StartTimePickerDialogFragment : DialogFragment() {
    private lateinit var binding: DialogStartTimePickerBinding
    ...
    fun setInitialTime(hour: Int, minute: Int) {
        ...
        binding.startTimePickerTp.hour = hour
        binding.startTimePickerTp.minute = adjustedMinute
    }
    ...
    override fun onCreateView(
        ...
        binding = DialogStartTimePickerBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setMinuteInterval(binding.startTimePickerTp, 5)
